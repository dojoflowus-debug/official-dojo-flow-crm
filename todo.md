...
## Replace Ask Kai Button with Centered KaiVersionChip (Jan 21, 2026)
- [x] Create version config constant (v0.9.0-beta)
- [x] Create KaiVersionChip component with red status indicator
- [x] Style chip with premium command center aesthetic (dark/gray with red accent)
- [x] Add hover tooltip "Kai Core v0.9.0-beta (Pilot Beta)"
- [x] Ensure keyboard accessibility (focus states, Enter/Space triggers)
- [x] Find current "Ask Kai" button location in header
- [x] Replace Ask Kai button with KaiVersionChip
- [x] Center chip between breadcrumb and right controls
- [x] Test responsive behavior on mobile/tablet/desktop
- [x] Verify same functionality as old Ask Kai button
- [ ] Save checkpoint
