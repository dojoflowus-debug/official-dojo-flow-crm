...
## UI Enhancement: Add @ Button to Kai Command Composer

### Requirements
- [x] Add @ symbol button to the left of the text input area
...
## Implement schedule file detection and class creation flow
- [x] Add schedule file detection when xlsx/xls/csv uploaded
- [x] Create SchedulePreviewCard component
- [x] Call extractSchedule API when schedule file detected
