...
## Phase 28: Bottom Navigation + Focus Mode
- [ ] Audit current navigation structure and layout
- [ ] Create Focus Mode toggle component and state management
- [ ] Implement localStorage persistence for Focus Mode
- [ ] Add smooth CSS transitions for entering/exiting Focus Mode (200-300ms)
- [ ] Restore bottom navigation bar with all menu items (Students, Leads, Kai, Classes, Kiosk, Floor Plans, Operations, Staff, Billing, Reports, Settings)
- [ ] Integrate Focus Mode into main layout wrapper
- [ ] Test Focus Mode on Studio page and other pages
- [ ] Add ESC key handler to exit Focus Mode
- [ ] Test persistence and transitions
- [ ] Verify Studio page works with navigation visible


## Phase 29: Bottom Navigation + Focus Mode
- [x] Restore bottom navigation bar with all menu items (Dashboard, Students, Leads, Kai, Classes, Kiosk, Floor Plans, Operations, Staff, Billing, Reports, Settings)
- [x] Implement Focus Mode toggle button (bottom-left of menu bar)
- [x] Hide top header bar when Focus Mode is ON
- [x] Hide bottom navigation bar when Focus Mode is ON
- [x] Hide left sidebar when Focus Mode is ON
- [x] Full-screen canvas mode in Focus Mode
- [x] ESC key to exit Focus Mode
- [x] localStorage persistence for Focus Mode state
- [x] Smooth CSS transitions (200-300ms) entering/exiting Focus Mode
- [x] Wrap KioskStudioExact with DojoFlowLayout to enable navigation
- [x] Verify Studio page works with navigation visible
