...
## Phase 37: Fix TRPC Errors (Jan 15, 2026) - COMPLETED
- [x] Fix missing kiosk.getKiosk procedure
- [x] Fix missing locations.listLocations procedure
- [x] Fix invalid input error (undefined object)
- [x] Test TRPC calls on /kai page
