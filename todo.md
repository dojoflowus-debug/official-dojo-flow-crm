...
## CRITICAL: Fix Vertical Strip Bug (Feb 3, 2026)
- [x] Restore root shell: height: 100vh, max-height: 100vh, overflow: hidden, display: grid
- [x] Enforce 3-column grid (no rows): use grid-template-columns only, NOT grid-template-rows
- [x] Set grid-auto-flow: column or remove auto-flow entirely
- [x] Make each panel self-contained: min-width: 0, min-height: 0, overflow: hidden
- [x] Center panel: display: flex, flex-direction: column, min-height: 0, min-width: 0, overflow: hidden
- [x] Message list: flex: 1, overflow: auto, min-height: 0
- [x] Composer: NOT position: fixed, must be inside center panel
- [x] Remove any backdrop/scrim/overlay artifacts
