...
export default function KaiCommand() {
  ...
  return (
    <ManagementLayout>
      ...
      <div ref={containerRef} className={`kai-command-page flex h-screen max-h-screen ${!isDark && !isCinematic && !isFocusMode ? '' : 'overflow-hidden'} ${getKaiCommandBgClass()} ${!isDark && !isCinematic && !isFocusMode ? 'kaiLightCommandCenter' : ''} ${isCinematic ? 'brightness-[0.85]' : ''} ${isFocusMode ? 'focus-mode fixed inset-0 z-50' : ''} transition-all duration-500 ease-in-out`}>
