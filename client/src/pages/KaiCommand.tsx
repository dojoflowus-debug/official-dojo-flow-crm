...
export default function KaiCommand() {
  ...
  const handleSendMessage = async (
    ...
    // Creative generation is handled by the Kai LLM via the generate_flyer tool.
    // Do NOT intercept here — let all messages flow through the main Kai chat path below.
