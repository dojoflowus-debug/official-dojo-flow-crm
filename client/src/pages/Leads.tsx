          ...
          <div className="max-w-[1600px] mx-auto px-4 md:px-6 pb-4">
            ...
            `}>
              ...
              <Button
                size="sm"
                variant="ghost"
                onClick={() => navigate('/kai-command?q=' + encodeURIComponent(`I have ${stats.aging} aging leads in my pipeline. What SMS follow-up strategies do you recommend to re-engage them?`))}
