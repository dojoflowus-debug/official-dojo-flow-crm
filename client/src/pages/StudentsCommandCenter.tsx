...
export default function StudentsCommandCenter() {
  ...
  return (
    <div className={cn("min-h-screen flex flex-col", isDarkMode ? "bg-[#0a0a0b]" : "bg-gray-50")}>
      <CommandHeader title="Students" stats={stats} isDarkMode={isDarkMode} />
      
      <div className={cn("border-b px-4 py-2 flex items-center gap-2 overflow-x-auto", isDarkMode ? "bg-[#0f0f10] border-white/10" : "bg-white border-gray-200")}>
      ...
      <div className="flex-1 flex overflow-hidden">
        <div className="w-1/2 relative border-r border-white/10">
          <LeafletMap ref={mapRef} markers={mapMarkers} selectedStudentId={selectedStudent?.id} onMarkerClick={handleMarkerClick} darkMode={isDarkMode} className="h-full" />
          ...
          <div className={cn("absolute bottom-4 left-4 p-3 rounded-xl backdrop-blur-xl border", isDarkMode ? "bg-black/60 border-white/10" : "bg-white/80 border-gray-200 shadow-lg")}>
        ...
        <div className={cn("w-1/2 flex flex-col", isDarkMode ? "bg-[#0f0f10]" : "bg-white")}>
          <div className={cn("p-4 border-b flex items-center gap-3", isDarkMode ? "border-white/10" : "border-gray-200")}>
