...
const PaymentsCommandCenter = lazy(() => import("../pages/PaymentsDashboard"));
...
export const appRoutes: RouteConfig[] = [
  ...
  { path: "/students", element: <AppShell><Students /></AppShell>, label: "Students" },
  ...
  { path: "/payments/dashboard", element: <AppShell><PaymentsCommandCenter /></AppShell>, label: "Payments Dashboard" },
  ...
  { path: "/kiosk-analytics", element: <AppShell><ProtectedRoute><KioskAnalytics /></ProtectedRoute></AppShell>, label: "Kiosk Analytics" },
