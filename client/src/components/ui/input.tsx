  ...
  return (
    <input
      ...
      className={cn(
        ...
        "border-input h-9 w-full min-w-0 rounded-md border bg-background px-3 py-1 text-base",
        "shadow-[0_1px_2px_oklch(0_0_0/0.04)] dark:bg-input/20",
        ...
        "focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/25 focus-visible:shadow-[0_0_0_3px_oklch(var(--ring)/0.12)]",
